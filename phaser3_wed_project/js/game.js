class Example extends Phaser.Scene {
    ...
    startGame() {
		...
		this.anims.create({ key: 'wall_spr', frames: this.anims.generateFrameNumbers('wall', [0,1,2,3,4,5,6,7]), frameRate: 30, repeat: -1 });
		this.anims.create({ key: 'wall_goal_spr', frames: this.anims.generateFrameNumbers('wall_goal', [0,1,2]), frameRate: 30, repeat: -1 });
