var PLANET = {};
    ...
    PLANET.send = function(dest) {
        /*
        var _baseUrl = "/popup/app_information.do"; // tmap 援щ룞
        var _searchUrl ="/popup/app_information.do?mode=search&alias=" + dest; // tmap 寃  됲솕硫  援щ룞
        ...
        */
        ...
        var _app = app;      //   紐⑸줉
        var _os = PLANET.os; //os 醫낅쪟

        var _baseUrl = _app.baseUrl[_os]; // tmap 援щ룞
        var _searchUrl = app.searchUrl[_os] + dest; // tmap 寃  됲솕硫  援щ룞
        ...
        if (_os == "ios"){
            ...
            window.location = _app.store['etc']; //湲고  T map  ъ씠    대룞
        }
